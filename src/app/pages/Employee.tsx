      ...
      <section className="relative pt-10 pb-24 md:pt-24 md:pb-32 overflow-hidden bg-[#A3C410] text-[#003B79] md:min-h-[787px] md:flex md:items-center">
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
           <img 
             ...
             className="w-full h-full object-cover object-[46%_12%] md:absolute md:inset-y-0 md:-left-[52%] md:w-[175%] md:max-w-none md:object-[70%_30%] opacity-60 mix-blend-overlay"
           />
